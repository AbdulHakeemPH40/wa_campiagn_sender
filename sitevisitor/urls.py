...
urlpatterns = [
    ...
    path('blog/direct-whatsapp-outreach-browser-extensions/', views.blog_post_direct_outreach, name='blog_post_direct_outreach'),
    ...
    path('blog/extension-power-more-than-whatsapp-web/', views.blog_post_extension_power, name='blog_post_extension_power'),
    ...
    # API endpoints
    path('api/verify-license/', api_views.verify_license, name='verify_license'),
